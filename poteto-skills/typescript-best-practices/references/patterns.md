...
Code examples for each rule in `SKILL.md`. The underlying principles are language-agnostic.
...
Validate once where data crosses in. Trust types inside. Guards belong at system boundaries, not scattered through internal code.
