...
6. For a big or wide change, spawn two or three independent `general-purpose` subagents with the same question (use different `model` values if you can) and merge the answers. Independent reviewers catch different real bugs.
