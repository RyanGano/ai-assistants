...
- `Skill` tool calls, and `<command-name>` tags for skills the user invoked with a slash command
...
- Tool calls (Bash, PowerShell, Grep, MCP, etc.) that match a skill's documented commands
